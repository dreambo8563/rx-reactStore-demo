                ...
                if (error) {
                    ...
                    if (this.state.currentTab == '1') {
                        changeHomeProps({
                            ...
                            aheadReminderAffectCount: Math.round(parseFloat(value.flightTickets) * 0.2),
                        ...
                        changeHomeProps({
                            ...
                            aheadReminderAffectCount: Math.round(parseFloat(value.flightConsume) / parseFloat(value.flightPrice) * 0.2),
