    ...
    render() {
        return (
            <BarChart
                ...
                <XAxis dataKey='name'/>
                <YAxis tickFormatter={(value) => `${parseFloat(value / 1000).toFixed(1)}k`}/>
                        ...
                        <div className={s.columnFlexContainer}>
                            ...
                            <div className={s.flexContainer}>
                                ...
                                <div className={cx(s.columnFlexContainer, s.flexItem, s.cell)}>
                                    ...
                                    <div className={s.number}>{moneyFormat(parseInt(flightTime + hotelTime + trainTime + taxiTime))}</div>
                                </div>
                            </div>
                            <div className={s.flexContainer}>
                                <div className={cx(s.columnFlexContainer, s.flexItem, s.cell)}>
                                    <div className={s.tableItemHeader}>纸张节省/张</div>
                                    <div className={s.number}>{moneyFormat(parseInt((parseFloat(homeState.flightTickets) + parseFloat(homeState.hotelTickets) + parseFloat(homeState.trainTickets) + parseFloat(homeState.taxiTickets)) * 0.25))}</div>
                                </div>
                                <div className={cx(s.columnFlexContainer, s.flexItem, s.cell)}>
                                    <div className={cx(s.tableItemHeader, s.opacity)}>总节省/元</div>
                                    <div className={cx(s.number, s.opacity)}>0</div>
